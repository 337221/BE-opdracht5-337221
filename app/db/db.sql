...
CREATE TABLE IF NOT EXISTS Product( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, Naam VARCHAR(250) NOT NULL, Barcode VARCHAR(250) NOT NULL, IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL) ENGINE = InnoDB;
INSERT INTO
   Product 
VALUES
   (
...
CREATE TABLE IF NOT EXISTS Magazijn( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, ProductId INT NOT NULL, VerpakkingsEenheid FLOAT NOT NULL, AantalAanwezig INT NULL, IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL, FOREIGN KEY (ProductId) REFERENCES Product(Id)) ENGINE = InnoDB;
INSERT INTO
   Magazijn 
VALUES
   (
...
CREATE TABLE IF NOT EXISTS Allergeen( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, Naam VARCHAR(250) NOT NULL, Omschrijving VARCHAR(250) NOT NULL, IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL) ENGINE = InnoDB;
INSERT INTO
   Allergeen 
VALUES
   (
...
CREATE TABLE IF NOT EXISTS ProductPerAllergeen( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, ProductId INT NOT NULL, AllergeenId INT NOT NULL, IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL, FOREIGN KEY (ProductId) REFERENCES Product(Id), FOREIGN KEY (AllergeenId) REFERENCES Allergeen(Id)) ENGINE = InnoDB;
INSERT INTO
   ProductPerAllergeen 
VALUES
   (
...
CREATE TABLE IF NOT EXISTS Leverancier( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, Naam VARCHAR(250) NOT NULL, ContactPersoon VARCHAR(250) NOT NULL, LeverancierNummer VARCHAR(250) NOT NULL, Mobiel VARCHAR(11) NOT NULL, IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL) ENGINE = InnoDB;
INSERT INTO
   Leverancier 
VALUES
   (
...
CREATE TABLE IF NOT EXISTS ProductPerLeverancier( Id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, LeverancierId INT NOT NULL, ProductId INT NOT NULL, DatumLevering DATE NOT NULL, Aantal INT NOT NULL, DatumEerstVolgendeLevering DATE NULL, IsActief BIT NOT NULL DEFAULT 1, Opmerkingen VARCHAR(250) NULL DEFAULT NULL, DatumAangemaakt DateTime(6) NOT NULL, DatumGewijzigd DateTime(6) NOT NULL, FOREIGN KEY (LeverancierId) REFERENCES Leverancier(Id), FOREIGN KEY (ProductId) REFERENCES Product(Id)) ENGINE = InnoDB;
INSERT INTO
